...
class _AddCardViewState extends State<AddCardView> {
  ...
  // Méthode pour stocker temporairement la carte
  void _saveCard(Flashcard card) {
    _currentCard = card;
    _saveCurrentCard();
  }

  // Méthode utilisée par le raccourci clavier
  void _saveCurrentCard() async {
    if (_currentCard != null) {
      await Provider.of<DatabaseHelper>(context, listen: false).saveCard(_currentCard!);
